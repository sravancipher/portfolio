...
function Contact(props) {
    return (
        <>
        <h1 className='text-center' style={{width:"380px"}}>I am <span ><TextTypingAnimation /></span></h1>
                <div className="card card2" style={{ width: "400px" }}  data-aos="fade-left" data-aos-duraton="2000">
                    <h1 className="card-text d-block text-center " style={{ color: "red" }} >Contact Me</h1>
                    <div class="card-body">
